...
@app.route('/file/metadata/<file>', methods=['GET'])
...
@app.route('/file/text/<file>', methods=['GET'])
...
@app.route('/file/create/<file>', methods=['GET'])
...
@app.route('/file/delete/<file_id>', methods=['GET', 'POST'])       
